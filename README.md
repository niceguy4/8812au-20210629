...
Note that during my test the wireless adapter works in Windows 11 prior to do anything. It shows networks and will connect to networks in Windows 11 but the wirelesss adapter did not work in Kali. If the card currently does not work in Windows 11, you may have to troubleshoot before moving forward with these steps.
